...
const Testimonialcard = () => {
    return (
            <div className=" mt-20 p-2 ml-20  w-[600px] border-2 border-gray-200 rounded-md">
                <div className="flex p-2">
                  <img alt="Sophia Carter" className="size-14 rounded-full" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDY46NsJfhMyze-o2MzIxPZkBJ1pxZ1CguxnUzda8ZjC_qRy2oyprOPNg4kSAcTlNaoHv6YfQ9B_GALVL_56HKPQ8zNrQvHchM3noxjcV8GcepPsE_B8YG1CrUkWH1m_DDSG-7h59sp7hSkuUa_DUwMnIgKWPhjJ0SFAaNWD5dDlDBTzipGRjpKFlbsyQlCFHlDkaTniKwclslH12uXdzaG5qc9NcnCyklPsCOjBeprIpZdPnh6QhimAioC69A70zJqtGmphpIHKa3X"/>
              ...
              <div>
                <p className="p-2 text-base text-slate-600 dark:text-slate-300 italic">"The personalized feedback on my writing was a game-changer. The instructors pinpointed my exact weaknesses and gave me the tools to overcome them. I couldn't have achieved my score without their help!"</p>
              </div>
            </div>
    )
}
