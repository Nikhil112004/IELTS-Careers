...
const Footer = () => {
    return (
        <div className='pt-30'>
            <footer className="border-t border-slate-200 bg-slate-50 px-2 sm:px-6 lg:px-8 py-8 dark:border-slate-800 dark:bg-slate-900/50">
           ...
           <div>
           <h3 class="font-semibold text-lg text-slate-900 dark:text-white">Resources</h3>
           <nav class="mt-4 flex flex-col gap-3">
           <a class="text-base text-slate-600 hover:text-primary dark:text-slate-400 dark:hover:text-primary" href="#">Blog</a>
           <a class="text-base text-slate-600 hover:text-primary dark:text-slate-400 dark:hover:text-primary" href="#">FAQs</a>
           <a class="text-base text-slate-600 hover:text-primary dark:text-slate-400 dark:hover:text-primary" href="#testimonials">Testimonials</a>
           </nav>
           </div>
           <div>
           <h3 class="font-semibold text-lg text-slate-900 dark:text-white">Follow Us</h3>
           <div class="mt-4 flex gap-4">
           <a class="text-slate-500 hover:text-primary dark:text-slate-400 dark:hover:text-primary" href="#">
           ...
           <div class="mt-12 border-t border-slate-200 dark:border-slate-800 pt-8 text-center text-base text-slate-500 dark:text-slate-400">
